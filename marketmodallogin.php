  ...
  <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top navbar-shrink" id="mainNav">
            <div class="container">
                ...
                <a class="navbar-brand js-scroll-trigger" href="#page-top"><h4 style="color:white;background-color:rgba(0,0,0,0.1);">Cross Domain Digital Marketing</h4></a>
        ...
        <!-- <header class="masthead">
            <div class="container">
                <div style="color:white;background-color:rgba(0,0,0,0.1);" class="masthead-subheading">Welcome To Cross Domain Digital World!</div>
                <div style="color:white;background-color:rgba(0,0,0,0.1);" class="masthead-heading text-uppercase">It's One Destination for your Favourate digital products and services</div>
